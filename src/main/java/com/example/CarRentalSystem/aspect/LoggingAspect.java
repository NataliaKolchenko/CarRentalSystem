package com.example.CarRentalSystem.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.example.CarRentalSystem.controller.*.*(..))")
    public void controllerLog(){}

    @Pointcut("execution(public * com.example.CarRentalSystem.service.*.*(..))")
